...
public class InsertUtil {
    ...
    public boolean insert(Map<String, String> mapStr, String table) {
        ...
        while (it.hasNext()) {
            String tmp_1 = (String) it.next();

            String tmp_1_str = (String) mapStr.get(tmp_1);
            if (tmp_1_str == null) {
                tmp_1_str = "";
            }
    ...
    public boolean insert(Map<String, String> mapStr, String table, RecordSetDataSource rsx) {
        ...
        while (it.hasNext()) {
            String tmp_1 = (String) it.next();
            String tmp_1_str = Util.null2String((String) mapStr.get(tmp_1));
            if (tmp_1_str.length() > 0) {
                sql_1.append(tmp_1);
                sql_1.append(",");
                if (tmp_1_str.contains("##")) {
