	...
	public String execute(RequestInfo info) {
		...
		StringBuffer sBuffer = new StringBuffer();
			...
			if (res.next()) {
                ...
                sBuffer.append("{");
				sBuffer.append('"');sBuffer.append("BOM");sBuffer.append('"');sBuffer.append(":");sBuffer.append("{");
			    sBuffer.append('"');sBuffer.append("BO");sBuffer.append('"');sBuffer.append(":");sBuffer.append("{");
			    sBuffer.append('"');sBuffer.append("AdmInfo");sBuffer.append('"');sBuffer.append(":");sBuffer.append("{");
			    sBuffer.append('"');sBuffer.append("Object");sBuffer.append('"');sBuffer.append(":");
		        sBuffer.append('"');sBuffer.append("2");sBuffer.append('"');sBuffer.append(",");
			    sBuffer.append('"');sBuffer.append("Version");sBuffer.append('"');sBuffer.append(":");
		        sBuffer.append('"');sBuffer.append("2");sBuffer.append('"');sBuffer.append("}");sBuffer.append(",");
		        sBuffer.append('"');sBuffer.append("BusinessPartners");sBuffer.append('"');sBuffer.append(":");sBuffer.append("{");
			    sBuffer.append('"');sBuffer.append("row");sBuffer.append('"');sBuffer.append(":");

				sBuffer.append("{\"CardCode\":\"");sBuffer.append(CardCode);
				sBuffer.append("\",\"Website\":\"");sBuffer.append(Website);
				sBuffer.append("\",\"CardName\":\"");sBuffer.append(CardName);
				sBuffer.append("\",\"Phone1\":\"");sBuffer.append(Phone1);
				sBuffer.append("\",\"Cellular\":\"");sBuffer.append(Cellular);
				sBuffer.append("\",\"AdditionalID\":\"");sBuffer.append(Addid);
				sBuffer.append("\",\"Notes\":\"");sBuffer.append(Notes);
                sBuffer.append("\",\"U_EmpID\":\"");sBuffer.append(U_EmpId);
                sBuffer.append("\",\"CardType\":\"");sBuffer.append("cCustomer");
                sBuffer.append('"');
                sBuffer.append("}");sBuffer.append("}");sBuffer.append(",");

                sBuffer.append('"');sBuffer.append("BPAddresses");sBuffer.append('"');sBuffer.append(":");sBuffer.append("{");
			    sBuffer.append('"');sBuffer.append("row");sBuffer.append('"');sBuffer.append(":");
			    sBuffer.append("[");sBuffer.append("{");
			    sBuffer.append("\"AddressType\":\"");sBuffer.append("bo_ShipTo");
				sBuffer.append("\",\"AddressName\":\"");sBuffer.append(ShipPerson);		
				sBuffer.append("\",\"Street\":\"");sBuffer.append(ShipAddr);	
				sBuffer.append("\",\"Block\":\"");sBuffer.append(ShipPhone);
				sBuffer.append("\",\"City\":\"");sBuffer.append(City);sBuffer.append('"');
				sBuffer.append("}");sBuffer.append("]}}}}");
