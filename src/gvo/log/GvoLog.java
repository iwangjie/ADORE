...
//		log_id = new Random().nextInt(1000);
    ...
    public void log_up(String id, String oper_emp, String oper_type, String oper_info,
        ...
        buffer.append("update gvo_all_log set oper_emp_code='");
        buffer.append(oper_emp);
        buffer.append("',");
        buffer.append("oper_type=");
        buffer.append(oper_type);
        buffer.append(",");
        buffer.append("oper_time=to_char(sysdate,'yyyy-mm-dd hh24:mi:ss'),");
        buffer.append("oper_info='");
        buffer.append(oper_info);
        buffer.append("',");
        buffer.append("oper_desc='");
        buffer.append(oper_desc);
        buffer.append("',");
        buffer.append("is_success=");
        buffer.append(is_success);
        buffer.append(",");
        buffer.append("return_info='");
        buffer.append(return_info);
