...
public class UpdatePublicSrc3WorkflowAction implements Action {
    public UpdatePublicSrc3WorkflowAction() {
    }

    public String execute(RequestInfo info) {
        (new BaseBean()).writeLog("归档UpdatePublicSrc3WorkflowAction_____________________________");
        ...
        if(!" ".equals(tableName)) {
            ...
            srcID = Util.null2String(res.getString("zymc"));
            if("".equals(srcID)) {
                (new BaseBean()).writeLog("资源ID错误");
                return "-1";
            }

            String sql_up = " update formtable_main_215 set zyzt = \'2\' where id = \'" + srcID + "\'";
