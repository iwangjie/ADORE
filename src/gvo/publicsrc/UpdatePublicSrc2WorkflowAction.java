...
public class UpdatePublicSrc2WorkflowAction implements Action {
    public UpdatePublicSrc2WorkflowAction() {
    }

    public String execute(RequestInfo info) {
        (new BaseBean()).writeLog("退回UpdatePublicSrc2WorkflowAction_______");
