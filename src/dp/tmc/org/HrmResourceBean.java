...
public class HrmResourceBean {
	...
	public String getJoblevel() {
		return Util.null2String(joblevel);
	}
	...
	public String getCostcenterid() {
		return Util.null2String(costcenterid);
	}
	...
	public String getAssistantid() {
		return Util.null2String(assistantid);
	}
	...
	public String getBelongtoCode() {
		return Util.null2String(belongtoCode);
	}
	...
	public String getManagerCode() {
		return Util.null2String(managerCode);
	}
	...
	public String getLoginid() {
		return Util.null2String(loginid);
	}
	...
	public String getPassword() {
		return Util.null2String(password);
	}
	...
	public String getLastname() {
		return Util.null2String(lastname);
	}
	...
	public String getBirthday() {
		return Util.null2String(birthday);
	}
	...
	public String getNationality() {
		return Util.null2String(nationality);
	}
	...
	public String getNationalityNew() {
		...
		if(nationality.matches("^\\d+$")){
			String sql = "select id from HrmCountry where id='"+nationality+"'";
			rs.executeSql(sql);
			if(rs.next()){
				nationalityID = rs.getInt("id");
			}
			if(nationalityID > 0)  return String.valueOf(nationalityID);
			return "1";
 		}
	...
	public String getMaritalstatus() {
		return Util.null2String(maritalstatus);
	}
	...
	public String getTelephone() {
		return Util.null2String(telephone);
	}
	...
	public String getMobilecall() {
		return Util.null2String(mobilecall);
	}
	...
	public String getLocationid(){
		return Util.null2String(locationid);
	}
	
	public String getLocationidNew() {
		RecordSet rs = new RecordSet();
		...
		tdu.insert("HrmLocations",mapStr);
	...
	public String getWorkroom() {
		return Util.null2String(workroom);
	}
	...
	public String getHomeaddress() {
		return Util.null2String(homeaddress);
	}
	...
	public String getStartdate() {
		return Util.null2String(startdate);
	}
	...
	public String getEnddate() {
		return Util.null2String(enddate);
	}
	...
	public String getJobtitle() {
		return Util.null2String(jobtitle);
	}
	...
	public String getJobactivitydesc() {
		return Util.null2String(jobactivitydesc);
	}
	...
	public String getDepartmentid() {
		return Util.null2String(departmentid);
	}
	...
	public String getManagerid() {
		return Util.null2String(managerid);
	}
	...
	public String getBankid1() {
		return Util.null2String(bankid1);
	}
	...
	public String getAccountid1() {
		return Util.null2String(accountid1);
	}
	...
	public String getCreaterid() {
		return Util.null2String(createrid);
	}
	...
	public String getDatefield1() {
		return Util.null2String(datefield1);
	}
	...
	public String getDatefield2() {
		return Util.null2String(datefield2);
	}
	...
	public String getDatefield3() {
		return Util.null2String(datefield3);
	}
	...
	public String getDatefield4() {
		return Util.null2String(datefield4);
	}
	...
	public String getDatefield5() {
		return Util.null2String(datefield5);
	}
	...
	public String getNumberfield1() {
		return Util.null2String(numberfield1);
	}
	...
	public String getNumberfield2() {
		return Util.null2String(numberfield2);
	}
	...
	public String getNumberfield3() {
		return Util.null2String(numberfield3);
	}
	...
	public String getNumberfield4() {
		return Util.null2String(numberfield4);
	}
	...
	public String getNumberfield5() {
		return Util.null2String(numberfield5);
	}
	...
	public String getTextfield1() {
		return Util.null2String(textfield1);
	}
	...
	public String getTextfield2() {
		return Util.null2String(textfield2);
	}
	...
	public String getTextfield3() {
		return Util.null2String(textfield3);
	}
	...
	public String getTextfield4() {
		return Util.null2String(textfield4);
	}
	...
	public String getTextfield5() {
		return Util.null2String(textfield5);
	}
	...
	public String getTinyintfield1() {
		return Util.null2String(tinyintfield1);
	}
	...
	public String getTinyintfield2() {
		return Util.null2String(tinyintfield2);
	}
	...
	public String getTinyintfield3() {
		return Util.null2String(tinyintfield3);
	}
	...
	public String getTinyintfield4() {
		return Util.null2String(tinyintfield4);
	}
	...
	public String getTinyintfield5() {
		return Util.null2String(tinyintfield5);
	}
	...
	public String getCertificatenum() {
		return Util.null2String(certificatenum);
	}
	...
	public String getNativeplace() {
		return Util.null2String(nativeplace);
	}
	...
	public String getEducationlevel() {
		return Util.null2String(educationlevel);
	}
	
	// 学历没有的 不新增 ，需要手动维护   只查询
	public String getEducationlevelNew() {
	...
	public String getWorkcode() {
		return Util.null2String(workcode);
	}
	...
	public String getRegresidentplace() {
		return Util.null2String(regresidentplace);
	}
	...
	public String getHealthinfo() {
		return Util.null2String(healthinfo);
	}
	
	public String getHealthinfoNew() {
		// 0优秀 1良好  2一般  3较差
	...
	public String getResidentplace() {
		return Util.null2String(residentplace);
	}
	...
	public String getPolicy() {
		return Util.null2String(policy);
	}
	...
	public String getDegree() {
		return Util.null2String(degree);
	}
	...
	public String getHeight() {
		return Util.null2String(height);
	}
	...
	public String getJobcall() {
		return Util.null2String(jobcall);
	}
	
	public String getJobcallNew() {
	...
	public String getAccumfundaccount() {
		return Util.null2String(accumfundaccount);
	}
	...
	public String getBirthplace() {
		return Util.null2String(birthplace);
	}
	...
	public String getExtphone() {
		return Util.null2String(extphone);
	}
	...
	public String getStatus() {
		return Util.null2String(status);
	}
	...
	public String getWeight() {
		return Util.null2String(weight);
	}
	...
	public String getTempresidentnumber() {
		return Util.null2String(tempresidentnumber);
	}
	...
	public String getProbationenddate() {
		return Util.null2String(probationenddate);
	}
	...
	public String getBelongto() {
		return Util.null2String(belongto);
	}
