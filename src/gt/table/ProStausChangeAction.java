...
public class ProStausChangeAction implements Action{
	...
	public String execute(RequestInfo request) {
		...
		while(rs.next()){
			...
			tmp_buff.append("update ");tmp_buff.append(formName);
			tmp_buff.append(" set ");tmp_buff.append(fieldName);
			tmp_buff.append(" = ");tmp_buff.append(status);
			tmp_buff.append(" where  ");tmp_buff.append(proCodeField2);
			tmp_buff.append(" = '");tmp_buff.append(proCode);tmp_buff.append("'");
